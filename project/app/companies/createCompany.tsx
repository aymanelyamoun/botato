"use client"
// import { Alert, Avatar, Button, Form, Modal, message } from "antd";
...
function CreateCompany({onCompanyChange}:{onCompanyChange:()=>void}) {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            await axios.post("/api/company", { name, location });
            setOpen(false);
            onCompanyChange();
            setNotification({ message: "Company created successfully.", type: 'success' });
            // queryClient.invalidateQueries(["companies"]);
        } catch {
            setNotification({ message: "Error creating company.", type: 'error' });
        } finally {
